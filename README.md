...
Search for `https://sxkmvlpzpkoiyvaowdyn.supabase.co` and `sb_publishable_xget8F5pAkCg0LyWsfUf-A_QhgcZWk-` in all HTML files and replace with your actual values. They appear in:
